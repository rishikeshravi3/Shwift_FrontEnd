...
//dummy code
        ...
        TextView requirementAndSkills=findViewById(R.id.applicant_view_job_description_requirement_skill_body);
        ...
        TextView education=findViewById(R.id.applicant_view_job_description_education_body);
